...
class UsagelicensPage extends StatefulWidget {
  const UsagelicensPage({super.key});

  @override
  State<UsagelicensPage> createState() => _UsagelicensPageState();
}

class _UsagelicensPageState extends State<UsagelicensPage> with BasicMixin {
  final List<Map<String, dynamic>> sections = [
    {
      "title": AppStrings.personalUseSectionTitle,
      "items": AppStrings.personalUseSectionItems,
    },
    {
      "title": AppStrings.redistributionSectionTitle,
      "items": AppStrings.redistributionSectionItems,
    },
    {
      "title": AppStrings.attributionSectionTitle,
      "items": AppStrings.attributionSectionItems,
    },
    {
      "title": AppStrings.ownershipSectionTitle,
      "items": AppStrings.ownershipSectionItems,
    },
    {
      "title": AppStrings.exclusiveSectionTitle,
      "items": AppStrings.exclusiveSectionItems,
    },
  ];
                ...
                children: [
                  const Center(
                    child: CustomHeaderLarge(
                      text: AppStrings.usagelicensTitle,
                    ),
                  ),
                  Text(
