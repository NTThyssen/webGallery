...
class _TermsPoliciesPageState extends State<TermsPoliciesPage> with BasicMixin {
  final List<Map<String, dynamic>> sections = [
    ...
    {
      "title": AppStrings.paymentSectionTitle,
      "items": AppStrings.paymentSectionItems,
    },
    {
      "title": AppStrings.processAndDeliverySectionTitle,
      "items": AppStrings.processAndDeliverySectionItems,
    },
    {
      "title": AppStrings.revisionsSectionTitle,
      "items": AppStrings.revisionsSectionItems,
    },
    {
      "title": AppStrings.clientResponsibilitiesSectionTitle,
      "items": AppStrings.clientResponsibilitiesSectionItems,
    },
    {
      "title": AppStrings.usageAndLicensingSectionTitle,
      "items": AppStrings.usageAndLicensingSectionItems,
    },
    {
      "title": AppStrings.portfolioSectionTitle,
      "items": AppStrings.portfolioSectionItems,
    },
    {
      "title": AppStrings.customerSatisfactionSectionTitle,
      "items": AppStrings.customerSatisfactionSectionItems,
    },
    {
      "title": AppStrings.refundPolicySectionTitle,
      "items": AppStrings.refundPolicySectionItems,
    },
    {
      "title": AppStrings.additionalNotesSectionTitle,
      "items": AppStrings.additionalNotesSectionItems,
    },
  ];
